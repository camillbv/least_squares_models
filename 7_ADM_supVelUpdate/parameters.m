...
TCelsius        =  220;  % Celsius   Reactor temperature    Satterfield(1991), table V 
supVelGasInit   =  0.11;  % m/s 	  gas phase superficial velocity Krishna (1999)
supVelLiqInit   =  0.01;  % m/s       liquid phase superficial velocity
volFracSol      =  0.5; % kg/kg     volume fraction of solids in reactor Krishna(2001), page 245 
...
kLa = 5 *[kLaCO kLaH2 kLaH2O kLaAlkanes']';
