...
volFracSol      =  0.2; % kg/kg     volume fraction of solids in reactor Krishna(2001), page 245 
...
%% area density
sauterDiameter  = 0.7*10^-3; % m Sauter Mean Diameter (DeckwerLoisiZaidiRalek1980) TO IMPROVE
