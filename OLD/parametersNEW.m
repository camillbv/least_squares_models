...
Mw  = [molWtCO   molWtH2   molWtH2O   molWtAlkanes']'; 
...
supVelLiqInit   =  0.02;  % m/s       liquid phase superficial velocity
...
diameter        = 1;   % m GUESSING
dispCoefLiq     = 0.68*diameter^1.4*supVelGasInit^0.3;
dispCoefGas     = 21.7*diameter^1.5*supVelGasInit^1.8;  
...
kLaH2O = kLaCO; % set to an arbitrarily value (most of the water is in gas phase at reactor conditions)
...
kLa = 0.01*[kLaCO kLaH2 kLaH2O kLaAlkanes']';
...
molFracLiqCOInit    = 1e-10;
molFracLiqH2Init    = 1e-10;
molFracLiqH2OInit   = 1e-10;
